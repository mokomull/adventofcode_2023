...
mod test {
    ...
    #[test]
    fn example() {
        assert_eq!(Solution::new(EXAMPLE_1).part1().unwrap(), 6);
        assert_eq!(Solution::new(EXAMPLE_2).part2().unwrap(), 6);
    }

    #[test]
    fn personal_input() {
        let solution = Solution::new(INPUT);
        assert_eq!(solution.part1().unwrap(), 16897);
        assert_eq!(solution.part2().unwrap(), 16563603485021);
    }

    static EXAMPLE_1: &str = "LLR

AAA = (BBB, BBB)
BBB = (AAA, ZZZ)
ZZZ = (ZZZ, ZZZ)";

    static EXAMPLE_2: &str = "LR
...
XXX = (XXX, XXX)";
    ...
    static INPUT:&str = "
