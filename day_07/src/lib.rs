...
mod test {
    ...
    fn example() {
        ...
        assert_eq!(example.part1().unwrap(), 6440);
        assert_eq!(example.part2().unwrap(), 5905);
    }

    #[test]
    fn personal_input() {
        let solution = Solution::new(INPUT);
        assert_eq!(solution.part1().unwrap(), 246912307);
        assert_eq!(solution.part2().unwrap(), 246894760);
    }
